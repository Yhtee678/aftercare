...
export const metadata: Metadata = { title: "听写" };
...
export default async function Page() {
  ...
  return <div className="space-y-6">
    <div className="flex flex-wrap items-center justify-between gap-4">
      <div><h1 className="text-2xl font-semibold">听写</h1><p className="mt-2 text-sm text-slate-600">先选择年级，再选择班级。任务数量包含所有日期。</p></div>
      <Link href="/dictation/new" className="inline-flex min-h-12 items-center gap-2 rounded-lg bg-blue-700 px-4 font-medium text-white"><Plus className="size-4" aria-hidden="true" /> 添加听写</Link>
    </div>
