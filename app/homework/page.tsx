...
export default async function Page() {
  ...
  return <div className="space-y-6">
    <div className="flex flex-wrap items-center justify-between gap-4">
      <div><h1 className="text-2xl font-semibold">Homework</h1><p className="mt-2 text-sm text-slate-600">Choose a grade, then a class. Task counts include all dates.</p></div>
      <Link href="/homework/new" className="inline-flex min-h-12 items-center gap-2 rounded-lg bg-blue-700 px-4 font-medium text-white"><Plus className="size-4" aria-hidden="true" /> Add Homework</Link>
    </div>
