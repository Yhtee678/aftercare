...
export default async function Page() {
  ...
  return <div className="space-y-8">
    ...
    <section className="space-y-3" aria-labelledby="attention-heading">
      ...
      <p className="text-sm text-slate-600">Unresolved corrections, including older tasks, then today’s unchecked bags.</p>
      {!data.corrections.length && !data.bags.length ? <p className="rounded-xl border border-green-200 bg-green-50 p-5 text-green-800">No urgent items right now.</p>
    ...
    <section className="space-y-4" aria-labelledby="classes-heading"><h2 id="classes-heading" className="text-xl font-semibold">Class Overview</h2>
      <p className="text-sm text-slate-600">Care and homework counts are for today. Attention counts include older corrections; one student may have several items.</p>
